...
public class Lab
{
    public static void main( String[] args )
    {
        ...
        System.setProperty("webdriver.chrome.driver","C:\\PATH TO YOUR DRIVER\\chromedriverWin.exe");
        ...
        System.out.println("Form header text = "
                + driver.findElement(By.cssSelector("div.wpb_wrapper h1")).getText() );
